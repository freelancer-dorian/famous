...
[![Build Status](https://travis-ci.org//slideshow.svg?branch=master)](https://travis-ci.org//slideshow) [![Dependency Status](https://david-dm.org//slideshow.svg)](https://david-dm.org//slideshow) [![devDependency Status](https://david-dm.org//slideshow/dev-status.svg)](https://david-dm.org//slideshow#info=devDependencies)
...
## Release History
 * 2014-05-25   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)